...
public class PlaybackUtils {
	...
	public ArrayList<VODRecord> getMoreVideoList(Client client,String startTime,String endTime){
	...
	public ArrayList<VODRecord> getVideoList(Client client,String startTime,String endTime){
		ArrayList<VODRecord> mList = new ArrayList<VODRecord>();
