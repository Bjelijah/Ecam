...
public class IntentWrapper {
    ...
    public static List<IntentWrapper> getIntentWrapperList() {
        if (sIntentWrapperList == null) {
            ...
            if (!DaemonEnv.sInitialized) return new ArrayList<IntentWrapper>();
            
            sIntentWrapperList = new ArrayList<IntentWrapper>();
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                if (!ignoringBatteryOptimizations) {
                    Intent dozeIntent = new Intent("android.settings.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS");
    ...
    public static List<IntentWrapper> whiteListMatters(final Activity a, String reason) {
        List<IntentWrapper> showed = new ArrayList<IntentWrapper>();
